    ...
    public static void main(String[] args) {
        ...
        while (j1==0) {
            ...
            while (j == 0) {
                ...
                jogo = sc.next();
                if ((jogo.equalsIgnoreCase("s")) || (jogo.equalsIgnoreCase("si")) || (jogo.equalsIgnoreCase("sim")) || (jogo.equalsIgnoreCase("n")) || (jogo.equalsIgnoreCase("na")) || (jogo.equalsIgnoreCase("nao")) || (jogo.equalsIgnoreCase("ñ")) || (jogo.equalsIgnoreCase("nã")) || (jogo.equalsIgnoreCase("não"))) {
                    j = 1;
                } else {
